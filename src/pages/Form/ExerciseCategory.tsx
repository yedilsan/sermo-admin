...
const ExerciseCategory = () => {
  ...
  const [exerciseCategoryIdInput, setExerciseCategoryIdInput] = useState('');
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="ExerciseCategory" />
      ...
      <hr className="mb-10" />
      <Breadcrumb pageName="Exercise Category Update" />
      <div className="grid grid-cols-1 gap-9 sm:grid-cols-1">
        <div className="flex flex-col gap-9">
          {/* <!-- Input Fields --> */}
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex flex-col gap-5.5 p-6.5">
              ...
              <div>
                ...
                <input
                  ...
                  value={exerciseCategoryIdInput}
                  onChange={(event) =>
                    setExerciseCategoryIdInput(event.target.value)
                  }
                  className="w-full rounded-lg border-[1.5px] border-stroke bg-transparent py-3 px-5 font-medium outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                />
              </div>
